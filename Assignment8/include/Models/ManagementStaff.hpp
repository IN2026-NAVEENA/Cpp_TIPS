...
class ManagementStaff : public Employee {
    public:
        /*
        @brief Constructs a new ManagementStaff object with the specified attributes.
        ...
        */
        ManagementStaff(int id, const std::string& name, const std::string& password, UserRole role, Position position, double salary) 
